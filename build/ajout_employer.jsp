        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="py-3 mb-6"><span class="text-muted fw-light"></span>Inserer un employer</h4>
                    <div class="row">

                        <div class="col-md-12">
                            <div class="card mb-12">
                                <div class="card-header d-flex align-items-center justify-content-between">
                                    <h5 class="mb-0">Inserer un employer</h5>
                                </div>
                                <div class="card-body">
                                    <form action="ajoutEmployerSubmit" method="post" class="form">
                                        ...
                                        <label class="col-sm-2 col-form-label" for="date">Date d'embauche</label>
                                        <div class="col-sm-10">
